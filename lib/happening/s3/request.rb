  ...
  module S3
    class Request
      ...
      def initialize(http_method, url, options = {})
        ...
        assert_valid_keys(options, :timeout, :on_success, :on_error, :on_retry, :on_not_modified, :retry_count, :headers, :data, :file, :ssl)
      ...
      def on_not_modified &blk
        options[:on_not_modified] = blk
      end
    ...
    protected
      ...
      def call_user_not_modified_handler
        options[:on_not_modified].call(self) if options[:on_not_modified].respond_to?(:call)
      end
